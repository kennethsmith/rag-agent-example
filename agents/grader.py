...
def invoke_retrieval_grader(grader, question, document) -> dict[str]:
...
def hallucination_grader():
    prompt = PromptTemplate(
        template="""You are a grader assessing whether an answer is grounded in / supported by a set of facts.
            ...
            Give a binary score 'yes' or 'no' score to indicate whether the answer is grounded in / supported 
            by a set of facts.
            
            Provide the binary score as a JSON document with a two keys 'score' which is the binary answer and 
            'reason' which contains your explanation.""",
...
def invoke_hallucination_grader(grader, docs, generation) -> dict[str]:
